...
parser.add_argument('--train', action='store_true',
                    help=' path selection set_policy training (default: False)')
...
parser.add_argument('--run_analysis', action='store_true', default=True,
                    help='run algorithm analysis and print intermediate emb_2D_d1results (default: False)')
...
# HRL
parser.add_argument('--rl_module', type=str, default='original',
                    help='original: REINFORCE; hrl: hierarchical REINFORCE', choices=['original', 'hrl'])
parser.add_argument('--hrl_ff_dropout', type=int, default=1,
                    help='whether to dropout relation and tailentity, 1 for dropout and otherwise')
parser.add_argument('--relation_dropout_rate', type=float, default=0.3)
parser.add_argument('--tailentity_dropout_rate', type=float, default=0.3)
parser.add_argument('--use_action_space_bucketing', action='store_true', default=False,
                    help='bucket adjacency list by outgoing degree to avoid memory blow-up (default: False)')
parser.add_argument('--use_relation_space_bucketing', action='store_true', default=False)
parser.add_argument('--gamma', type=float, default=0.99,
                    help='moving average weight (default: 1)')
parser.add_argument('--beam_size_high', type=int, default=4,
                    help='size of beam used in beam search inference (default: 100)')
parser.add_argument('--beam_size_low', type=int, default=12)
parser.add_argument('--beam_size', type=int, default=32,
                    help='size of beam used in beam search inference (default: 100)')

parser.add_argument('--checkpoint_path', type=str, default=None,
                    help='path to a pretrained checkpoint')
parser.add_argument('--additional_tailentity_size', type=int, default=96, choices=[4, 8, 16, 32, 64, 96, 128])

parser.add_argument('--num_epochs_print', type=int, default=20)
